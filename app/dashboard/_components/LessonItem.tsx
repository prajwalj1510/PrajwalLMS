...
export const LessonItem = ({ lesson, slug, isActive, completed }: LessonItemProps) => {
            ...
            <div className="flex items-center gap-2.5 w-full min-w-0">
                <div className="shrink-0">
                    {completed ? (
                        ...
                        <div className={cn('size-5 rounded-full border-2 bg-background flex justify-center items-center', isActive ? 'border-primary bg-primary/10 dark:bg-primary/20' : 'border-muted-foreground/60')}>
                            <Play className={cn(
                ...
                <div className="flex-1 text-left min-w-0">
                    ...
                    {completed && (
                        <p className="text-[10px] text-green-700 dark:text-green-300 text-medium">Completed</p>
                    )}
