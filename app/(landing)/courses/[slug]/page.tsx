            ...
            <div className="order-1 lg:col-span-2">
                ...
                <div className="mt-8 space-y-6">
                    <div className="space-y-4">
                        ...
                        <p className="text-xl text-muted-foreground leading-relaxed line-clamp-2">{course.smallDescription}</p>
                    </div>
                                        ...
                                        <div className="border-t bg-muted/20">
                                            <div className="p-6 pt-4 space-y-3">
                                                {chapter.lessons.map((lesson, index) => (
                                                    <div key={lesson.id} className="flex items-center gap-4 rounde-lg p-3 hover:bg-accent transition-colors group">
